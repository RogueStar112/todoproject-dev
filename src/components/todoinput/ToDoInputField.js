...
const ToDoInputField = (props) => {
    return (
      ...
      <Form.Control className="" type={props.type} value={props.value} onChange={props.onChange} name={props.name} placeholder={props.placeholder} style={{width: "100%"}} autocomplete="false">
      </Form.Control>
      </div>
    );
  }
